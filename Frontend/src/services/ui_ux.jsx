...
export default function HeroSection() {
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="text-white animate-fadeInUp ml-30">
              ...
              <p className="text-lg text-blue-900 max-w-xl">
                We create intuitive, beautiful, and conversion-focused user experiences that delight users and drive business growth.
              </p>

              <div className="mt-8 border-l-4 border-blue-500 pl-6 italic text-blue-900">
                We focus on user-centered design and measurable digital success.
              </div>
            </div>
            ...
            <div className="overflow-hidden bg-transparent">
              <img
                src="/servicesimg/uiux design.png"
                alt="UI/UX Design"
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed text-[15px]">
                We are a leading UI/UX design company helping businesses create exceptional digital experiences
                that users love. Our solutions are built on user research, design thinking, and deep understanding of human behavior.
              </p>

              <p className="mt-4 text-gray-600 leading-relaxed text-[15px]">
                Our UI/UX experts specialize in user research, wireframing, prototyping, visual design, and usability testing.
                From initial discovery and user analysis to design implementation and optimization, we provide end-to-end solutions focused on
                user satisfaction, engagement, and business goals.
              </p>
            </div>
          </div>
        </div>
      ...
      <WebDesignProcess />
      {/* =============================================================================================== */}
      {/* UI/UX DESIGN ADVANTAGES SECTION */}
      <section className="w-full bg-gray-50 py-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="text-4xl font-semibold text-center text-[#243B6B] mb-16">
            Unlocking the Advantages of Professional UI/UX Design
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <FlipBox
              ...
              description="Deep user research and empathy-driven design processes that create experiences users truly love and engage with."
            />
            ...
            <FlipBox
              ...
              description="Intuitive interfaces and seamless interactions that make your digital products delightful and easy to use across all devices."
            />
            ...
            <FlipBox
              ...
              description="Strategic design decisions and optimized user flows that guide users toward desired actions and improve business metrics."
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            ...
            <FlipBox
              ...
              description="Comprehensive design systems and component libraries that ensure consistency and efficiency across your entire product ecosystem."
            />
            ...
            <FlipBox
              ...
              description="WCAG-compliant designs that ensure your digital products are usable by everyone, including users with disabilities."
            />
            ...
            <FlipBox
              ...
              description="Analytics-informed design choices and A/B testing that continuously optimize user experience based on real user behavior data."
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Modern design tools and technologies we use to create exceptional user experiences
            </p>
          </div>
      ...
      <section className="w-full bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We've helped businesses across various industries create exceptional user experiences with our UI/UX design solutions
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">
              Ready to Transform Your Digital Experience with
              <br /> Professional UI/UX Design?
            </h2>
            <p className="text-gray-600 mb-8">
              Create intuitive, beautiful, and conversion-focused user experiences that delight users and drive business growth.
            </p>
