          ...
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            ...
            <div className="text-white animate-fadeInUp ml-30">
              ...
              <p className="text-lg text-blue-900 max-w-xl">
                We build high-converting e-commerce websites that drive sales, enhance customer experience, and scale with your business growth.
              </p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="mt-6 text-gray-600 leading-relaxed text-[15px]">
                We are a leading e-commerce development company helping businesses create powerful,
                scalable, and secure online stores. Our solutions are built on
                cutting-edge development practices, e-commerce expertise, and deep understanding of online retail.
              </p>

              <p className="mt-4 text-gray-600 leading-relaxed text-[15px]">
                Our e-commerce experts specialize in custom store development, payment gateway integration,
                inventory management, and user experience optimization. From initial consultation and requirements analysis to
                deployment and ongoing support, we provide end-to-end solutions focused on conversions,
      ...
      <section className="w-full bg-gray-50 py-20 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h2 className="text-4xl font-semibold text-center text-[#243B6B] mb-16">
            Unlocking the Advantages of Professional E-commerce Development
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <FlipBox
              ...
              description="Optimized e-commerce websites with seamless user experience, intuitive navigation, and persuasive design that drives higher conversion rates and boosts sales."
            />
            ...
            <FlipBox
              ...
              description="Responsive e-commerce designs that provide exceptional shopping experiences across all devices, ensuring customers can shop anytime, anywhere."
            />
            ...
            <FlipBox
              ...
              description="Multiple secure payment gateway integrations with PCI compliance, fraud detection, and seamless checkout processes for customer trust."
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            ...
            <FlipBox
              ...
              description="Real-time inventory tracking, automated stock updates, and comprehensive product management systems for efficient operations."
            />
            ...
            <FlipBox
              ...
              description="SEO-friendly e-commerce platforms with product optimization, category pages, and technical SEO to improve search rankings and organic traffic."
            />
            ...
            <FlipBox
              ...
              description="Advanced analytics dashboards providing insights into sales performance, customer behavior, and conversion metrics for data-driven decisions."
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Modern e-commerce platforms and technologies we use to build powerful online stores
            </p>
          </div>

          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8">
            {[
              { name: "Shopify", category: "Platform", icon: "🛒" },
              { name: "WooCommerce", category: "WordPress", icon: "🏪" },
              { name: "Magento", category: "Enterprise", icon: "🏬" },
              { name: "BigCommerce", category: "SaaS", icon: "🛍️" },
              { name: "React", category: "Frontend", icon: "⚛️" },
              { name: "Node.js", category: "Backend", icon: "�" },
              { name: "Stripe", category: "Payments", icon: "�" },
              { name: "PayPal", category: "Payments", icon: "💰" },
              { name: "AWS", category: "Cloud", icon: "☁️" },
              { name: "Google Analytics", category: "Analytics", icon: "📊" },
              { name: "Mailchimp", category: "Email", icon: "📧" },
              { name: "ShipStation", category: "Shipping", icon: "🚚" }
            ].map((tech, index) => (
      ...
      <section className="w-full bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We've helped businesses across various industries establish successful online stores with our e-commerce solutions
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          <div className="relative z-10">
            <h2 className="text-3xl md:text-4xl font-bold text-[#0F172A] mb-4">
              Ready to Launch Your Online Store with
              <br /> Professional E-commerce Development?
            </h2>
            <p className="text-gray-600 mb-8">
              Build a high-converting e-commerce website that drives sales, enhances customer experience, and grows your business.
            </p>
    ...
    <section className="w-full bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center relative">
        ...
        <h2 className="text-4xl font-semibold text-[#243B6B] mb-24">
          Our E-commerce Development Process at
